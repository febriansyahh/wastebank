...
$pdf->Cell(25.5,0.7,"BANK SAMPAH",0,10,'C');
$pdf->ln(1);
...
$pdf->Cell(5, 0.8, 'Nasabah', 1, 0, 'C');
$pdf->Cell(4.5, 0.8, 'Berat', 1, 0, 'C');
...
$pdf->Cell(4.5, 0.8, $lihat['berat'],1, 0, 'L');
$pdf->Cell(5, 0.8, $lihat['total'], 1, 0,'L');
$pdf->Cell(4.5, 0.8, date('d-m-Y', strtotime($lihat['tanggal'])),1, 1, 'L');
